...
class EmailAfterApprovedViewController: BaseViewController, UIWebViewDelegate, SaveAndEmailViewControllerDelegate, GoToFileDelegate{
    ...
    @IBAction func reloadPDF(sender: AnyObject?) {
        ...
        let url = "https://contractssl.buildersaccess.com/bavenue_contractDocument?idcontract="
            + (contractInfo?.idcontract ?? "") + "&email=&password" 
    ...
    override func viewDidLoad() {
        ...
        self.title = contractInfo?.eventName ?? ""
...
//                        emailList.append(contrat.consultantemail)
